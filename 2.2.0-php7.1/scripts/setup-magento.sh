...
chmod -R 755 /var/www/html  && chmod -R 777 /var/www/html/var /var/www/html/pub /var/www/html/magento2-sample-data-$MAGENTO_VERSION && chmod u+x /app/bin/magento
